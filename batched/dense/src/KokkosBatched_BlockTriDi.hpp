...
//
//@HEADER
#ifndef __KOKKOSBATCHED_BLOCK_TRIDI_DECL_HPP__
#define __KOKKOSBATCHED_BLOCK_TRIDI_DECL_HPP__

//#include "KokkosBatched_BlockTriDi_spec.hpp"

namespace KokkosBatched {
// clang-format off
/// \brief Solve system Ax=b where A is block tridiagonal.
///
