...
#ifndef __KOKKOSBATCHED_BLOCK_TRIDI_HANDLE_DECL_HPP__
#define __KOKKOSBATCHED_BLOCK_TRIDI_HANDLE_DECL_HPP__
...
#endif  // __KOKKOSBATCHED_BLOCK_TRIDI_HANDLE_DECL_HPP__
