...
#define KOKKOSBLAS2_DGEMV_BLAS(EXEC_SPACE, LAYOUTA, LAYOUTX, LAYOUTY, ETI_SPEC_AVAIL)                                  \
  ...
  struct GEMV<EXEC_SPACE, Kokkos::View<const double**, LAYOUTA, EXEC_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    using XViewType = Kokkos::View<const SCALAR*, LAYOUTX, EXEC_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> >;      \
    using YViewType = Kokkos::View<SCALAR*, LAYOUTY, EXEC_SPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> >;            \
                                                                                                                       \
